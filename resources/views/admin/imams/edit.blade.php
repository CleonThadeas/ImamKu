...
<div class="card" style="max-width:600px">
    <form method="POST" action="{{ route('admin.imams.update', $imam) }}">
        ...
        <div class="form-group">
            ...
            <input type="email" name="email" class="form-input" value="{{ old('email', $imam->email) }}" required>
        </div>
        <div class="form-group">
            <label class="form-label">No. HP (WhatsApp)</label>
            <input type="text" name="phone" class="form-input" value="{{ old('phone', $imam->phone) }}" placeholder="628xxxxxxxxxx">
        </div>
        <div class="form-group">
